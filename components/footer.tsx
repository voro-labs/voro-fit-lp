      ...
      <div className="container mx-auto px-4">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="#planos" className="text-muted-foreground transition-colors hover:text-foreground">
                  Planos
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/suporte" className="text-muted-foreground transition-colors hover:text-foreground">
                  Suporte
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 md:flex-row">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} VoroLabs. Todos os direitos reservados.
          </p>
          <div className="flex gap-4">
            <Link
              href="https://www.instagram.com/vorolabs"
            ...
            <Link
              href="https://www.linkedin.com/company/vorolabs"
              className="text-muted-foreground transition-colors hover:text-foreground"
              aria-label="LinkedIn"
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
